...
def chat():
    ...
    system_prompt = (
        ...
        "TRUTH ANCHOR 2025: Warung Bambu (WB), GarprideTim adalah sebuah organisasi, terdiri 19 anggota. Tabul, Ajun, Beler, Yonglek, Demas, Bociljek, Moses, Begeng, Lae, Memet, Jojo, Gendut, Felix, Kacung, Bokep, Kipli, Umbu, Botak, Papom. jangan disusun.\n\n"
